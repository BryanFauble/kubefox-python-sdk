...
class TracesData(_message.Message):
    ...
    def __init__(
        self,
        resource_spans: _Optional[_Iterable[_Union[ResourceSpans, _Mapping]]] = ...,
    ) -> None: ...
...
class ResourceSpans(_message.Message):
    ...
    def __init__(
        ...
        scope_spans: _Optional[_Iterable[_Union[ScopeSpans, _Mapping]]] = ...,
...
class Span(_message.Message):
    ...
    def __init__(
        ...
        span_id: _Optional[bytes] = ...,
        trace_state: _Optional[str] = ...,
        parent_span_id: _Optional[bytes] = ...,
        flags: _Optional[int] = ...,
        name: _Optional[str] = ...,
        kind: _Optional[_Union[Span.SpanKind, str]] = ...,
        start_time_unix_nano: _Optional[int] = ...,
        end_time_unix_nano: _Optional[int] = ...,
        attributes: _Optional[_Iterable[_Union[_common_pb2.KeyValue, _Mapping]]] = ...,
        dropped_attributes_count: _Optional[int] = ...,
        events: _Optional[_Iterable[_Union[Span.Event, _Mapping]]] = ...,
        dropped_events_count: _Optional[int] = ...,
        links: _Optional[_Iterable[_Union[Span.Link, _Mapping]]] = ...,
        dropped_links_count: _Optional[int] = ...,
