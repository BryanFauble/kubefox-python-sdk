...
class MetricsData(_message.Message):
    ...
    def __init__(
        self,
        resource_metrics: _Optional[_Iterable[_Union[ResourceMetrics, _Mapping]]] = ...,
    ) -> None: ...
...
class ResourceMetrics(_message.Message):
    ...
    def __init__(
        self,
        resource: _Optional[_Union[_resource_pb2.Resource, _Mapping]] = ...,
        scope_metrics: _Optional[_Iterable[_Union[ScopeMetrics, _Mapping]]] = ...,
        schema_url: _Optional[str] = ...,
    ) -> None: ...
...
class ScopeMetrics(_message.Message):
    ...
    def __init__(
        self,
        scope: _Optional[_Union[_common_pb2.InstrumentationScope, _Mapping]] = ...,
...
class Metric(_message.Message):
    ...
    def __init__(
        ...
        unit: _Optional[str] = ...,
        gauge: _Optional[_Union[Gauge, _Mapping]] = ...,
        sum: _Optional[_Union[Sum, _Mapping]] = ...,
        histogram: _Optional[_Union[Histogram, _Mapping]] = ...,
        exponential_histogram: _Optional[_Union[ExponentialHistogram, _Mapping]] = ...,
        summary: _Optional[_Union[Summary, _Mapping]] = ...,
        metadata: _Optional[_Iterable[_Union[_common_pb2.KeyValue, _Mapping]]] = ...,
    ) -> None: ...
...
class Gauge(_message.Message):
    ...
    def __init__(
        self, data_points: _Optional[_Iterable[_Union[NumberDataPoint, _Mapping]]] = ...
    ) -> None: ...
...
class Sum(_message.Message):
    ...
    def __init__(
        self,
        data_points: _Optional[_Iterable[_Union[NumberDataPoint, _Mapping]]] = ...,
        aggregation_temporality: _Optional[_Union[AggregationTemporality, str]] = ...,
        is_monotonic: bool = ...,
    ) -> None: ...
...
class Histogram(_message.Message):
    ...
    def __init__(
        self,
        data_points: _Optional[_Iterable[_Union[HistogramDataPoint, _Mapping]]] = ...,
        aggregation_temporality: _Optional[_Union[AggregationTemporality, str]] = ...,
    ) -> None: ...
...
class ExponentialHistogram(_message.Message):
    ...
    def __init__(
        ...
        data_points: _Optional[
            _Iterable[_Union[ExponentialHistogramDataPoint, _Mapping]]
        ] = ...,
        aggregation_temporality: _Optional[_Union[AggregationTemporality, str]] = ...,
    ) -> None: ...
...
class Summary(_message.Message):
    ...
    def __init__(
        self,
        data_points: _Optional[_Iterable[_Union[SummaryDataPoint, _Mapping]]] = ...,
    ) -> None: ...
...
class NumberDataPoint(_message.Message):
    ...
    def __init__(
        ...
        start_time_unix_nano: _Optional[int] = ...,
        time_unix_nano: _Optional[int] = ...,
        as_double: _Optional[float] = ...,
        as_int: _Optional[int] = ...,
        exemplars: _Optional[_Iterable[_Union[Exemplar, _Mapping]]] = ...,
        flags: _Optional[int] = ...,
    ) -> None: ...
...
class HistogramDataPoint(_message.Message):
    ...
    def __init__(
        ...
        explicit_bounds: _Optional[_Iterable[float]] = ...,
        exemplars: _Optional[_Iterable[_Union[Exemplar, _Mapping]]] = ...,
        flags: _Optional[int] = ...,
        min: _Optional[float] = ...,
        max: _Optional[float] = ...,
...
class ExponentialHistogramDataPoint(_message.Message):
    ...
    def __init__(
        ...
        positive: _Optional[
            _Union[ExponentialHistogramDataPoint.Buckets, _Mapping]
        ] = ...,
        negative: _Optional[
            _Union[ExponentialHistogramDataPoint.Buckets, _Mapping]
        ] = ...,
        ...
        min: _Optional[float] = ...,
        max: _Optional[float] = ...,
        zero_threshold: _Optional[float] = ...,
    ) -> None: ...
...
class SummaryDataPoint(_message.Message):
    ...
    count: int
    sum: float
    quantile_values: _containers.RepeatedCompositeFieldContainer[
    ...
    def __init__(
        ...
        count: _Optional[int] = ...,
        sum: _Optional[float] = ...,
        quantile_values: _Optional[
            _Iterable[_Union[SummaryDataPoint.ValueAtQuantile, _Mapping]]
        ] = ...,
        flags: _Optional[int] = ...,
    ) -> None: ...
...
class Exemplar(_message.Message):
    ...
    filtered_attributes: _containers.RepeatedCompositeFieldContainer[
        _common_pb2.KeyValue
    ]
    time_unix_nano: int
    as_double: float
    as_int: int
    ...
    def __init__(
        self,
        filtered_attributes: _Optional[
            _Iterable[_Union[_common_pb2.KeyValue, _Mapping]]
        ] = ...,
        time_unix_nano: _Optional[int] = ...,
        as_double: _Optional[float] = ...,
        as_int: _Optional[int] = ...,
